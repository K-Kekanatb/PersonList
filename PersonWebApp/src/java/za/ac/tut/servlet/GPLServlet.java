 ...
 * @author khuts
 */
public class GPLServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Person> partialList = pfl.findRange(range); //get list within specified range
        request.setAttribute("partialList", partialList);
        request.setAttribute("startIndex", startIndex);
        request.setAttribute("endIndex", endIndex);
        
        RequestDispatcher rd = request.getRequestDispatcher("get_partial_list_outcome.jsp");
